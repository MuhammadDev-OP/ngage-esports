...
const Hero = () => {
  return (
    <div className="bg-[#242551]">
      <Wrapper>
        <div className="flex flex-col content-center pt-12 pb-10">
          <div>
            <h1 className="text-4xl text-center font-bold"> NGAGE Esports</h1>
          </div>
          <div className="mt-5">
            <p className="text-center">
              ...
              popular form of competition, with millions of people tuning in to
              watch the best compete. Ngage esports hopes to become the global
              standard for professional gaming.
            </p>
          </div>
      ...
      <div className="relative mt-24 p-10 bg-[#fdda0d]">
